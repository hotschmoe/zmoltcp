...
- Phase 4: IoT / Constrained Networks -- DEFERRED
...
Deferred 2026-02-25. Laminae does not currently target IEEE 802.15.4 or mesh
networks. Will revisit when/if constrained radio support is needed.

Only needed if Laminae targets IEEE 802.15.4 radios or mesh networks.
Can be deferred indefinitely if Laminae is Ethernet/WiFi only.
